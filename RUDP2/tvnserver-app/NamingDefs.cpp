...
const TCHAR LogNames::SERVER_LOG_FILE_STUB_NAME[] = _T("URDP2_tvnserver");
const TCHAR LogNames::VIEWER_LOG_FILE_STUB_NAME[] = _T("URDP2_tvnviewer");
const TCHAR LogNames::LOG_DIR_NAME[] = _T("URDP2");
const TCHAR LogNames::LOG_PIPE_PUBLIC_NAME[] = _T("URDP2_TVN_log_pipe_public_name");
const TCHAR LogNames::WIN_EVENT_PROVIDER_NAME[] = _T("URDP2_tvnserver");

const TCHAR ClipboardNames::CLIPBOARD_WIN_CLASS_NAME[] = 
  _T("URDP2_Tvnserver.Clipboard.MessageWindow");
...
const TCHAR DefaultNames::DEFAULT_COMPUTER_NAME[] = _T("localhost");
