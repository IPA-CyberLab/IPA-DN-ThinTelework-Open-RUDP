...
extern bool g_no_clipboard;
extern bool g_no_fileshare;
...
bool ViewerWindow::onCreate(LPCREATESTRUCT lps)
{
  ...
  m_toolbar.setViewAutoButtons(4 - 2, ToolBar::TB_Style_sep);
  m_toolbar.setViewAutoButtons(6 - 2, ToolBar::TB_Style_sep);
  m_toolbar.setViewAutoButtons(10 - 2, ToolBar::TB_Style_sep);
  m_toolbar.setViewAutoButtons(11 - 2, ToolBar::TB_Style_sep);
  m_toolbar.setViewAutoButtons(15 - 2, ToolBar::TB_Style_sep);
