  ...
  try {
    try {
      ...
      */
      ...
      RegKey rootKey;
      rootKey.createKey(configKey, _T("Software\\Thin Telework Private Version\\URDP Server"));
      ...
      config.start(configKey, _T("Software\\Thin Telework Private Version\\URDP Server"));
