  ...
  try {
    try {
      ...
      */
      ...
      RegKey rootKey;
      rootKey.createKey(configKey, _T("Software\\Thin Telework Open Source Version\\URDP Server"));
      ...
      config.start(configKey, _T("Software\\Thin Telework Open Source Version\\URDP Server"));
      ...
      TCHAR* propSheetTitle = _T("リモートデスクトップ設定 (システムモード)");
      if (configKey == HKEY_CURRENT_USER)
        propSheetTitle = _T("リモートデスクトップ設定 (ユーザーモード)");
